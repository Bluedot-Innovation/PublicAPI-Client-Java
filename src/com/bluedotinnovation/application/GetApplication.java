...
public class GetApplication extends BDCommon {
	...
	public static void main(String[] args) throws IOException, KeyManagementException, NoSuchAlgorithmException {
		...
		String bdApiKey     = "a4e5b264-d231-436b-b30e-4065bd517f02";
		String bdCustomerApiKey = "86577370-7b91-11e4-bcb7-a0481cdc3311";
		String bdRestUrl        = "https://api.bluedotinnovation.com/1/applications?customerApiKey=" +bdCustomerApiKey + "&apiKey=" + bdApiKey;
